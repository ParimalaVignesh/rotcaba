...
set name ecg_denoiser_mul_24s_40s_63_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ecg_denoiser_conv_layer01234_fused_Pipeline_L0_K_denoiser_w_L0_W_V_ROM_NP_LUTRAM_1R BINDTYPE {storage} TYPE {rom_np} IMPL {lutram} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln81 \
    op interface \
    ports { add_ln81 { I 9 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln82_1 \
    op interface \
    ports { add_ln82_1 { I 10 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_x_V_out \
    op interface \
    ports { x_V_out { O 32 vector } x_V_out_ap_vld { O 1 bit } } \
} "
}
