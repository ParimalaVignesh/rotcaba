set moduleName ecg_denoiser_Pipeline_READ_INPUT
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ecg_denoiser_Pipeline_READ_INPUT}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_buf_V_1 int 32 regular {array 180 { 0 } 0 1 }  }
	{ input_buf_V int 32 regular {array 180 { 0 } 0 1 }  }
...
set portList { 
	...
	{ input_buf_V_1_address0 sc_out sc_lv 8 signal 0 } 
	...
	{ input_buf_V_address0 sc_out sc_lv 8 signal 1 } 
...
set Spec2ImplPortList { 
	input_buf_V_1 { ap_memory {  { input_buf_V_1_address0 mem_address 1 8 }  { input_buf_V_1_ce0 mem_ce 1 1 }  { input_buf_V_1_we0 mem_we 1 1 }  { input_buf_V_1_d0 mem_din 1 32 } } }
	input_buf_V { ap_memory {  { input_buf_V_address0 mem_address 1 8 }  { input_buf_V_ce0 mem_ce 1 1 }  { input_buf_V_we0 mem_we 1 1 }  { input_buf_V_d0 mem_din 1 32 } } }
