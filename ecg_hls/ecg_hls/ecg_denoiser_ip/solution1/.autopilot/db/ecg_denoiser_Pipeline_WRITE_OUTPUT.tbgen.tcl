set moduleName ecg_denoiser_Pipeline_WRITE_OUTPUT
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ecg_denoiser_Pipeline_WRITE_OUTPUT}
set C_modelType { void 0 }
set C_modelArgList {
	{ buf41210 int 32 regular {array 360 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "buf41210", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ buf41210_address0 sc_out sc_lv 9 signal 0 } 
	{ buf41210_ce0 sc_out sc_logic 1 signal 0 } 
	{ buf41210_q0 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf41210_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "buf41210", "role": "address0" }} , 
 	{ "name": "buf41210_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buf41210", "role": "ce0" }} , 
 	{ "name": "buf41210_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buf41210", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	buf41210 { ap_memory {  { buf41210_address0 mem_address 1 9 }  { buf41210_ce0 mem_ce 1 1 }  { buf41210_q0 in_data 0 32 } } }
